    ...
    <>
      ...
      <section className="section" style={{ background:"#FFF9F4" }}>
        <div className="container">
          ...
          <div className="grid-auto">
            {[
              { icon:"🏫", who:"Schools & Educators", desc:"Implement a structured, results-driven literacy system in your classrooms. Access the full 16-step lesson plan, decodable books, and teacher training.", tag:"Classroom-Ready" },
              ...
              { icon:"🌐", who:"Organisations & NGOs", desc:"Expand access to literacy through community-based and sponsored programs. Our resources are designed to work in under-resourced settings.", tag:"Community Impact" },
              { icon:"👨‍👩‍👧", who:"Parents & Community Leaders", desc:"Support learning at home and strengthen the connection between school and family. Our home support guides are written in plain, accessible language.", tag:"Family-Friendly" },
            ].map(w=>(
      ...
      <section className="section" style={{ background:"white" }}>
        <div className="container">
          ...
          <div className="grid-auto">
            {[
              { icon:"📋", title:"Adopt the Program", desc:"Bring FastTrack Literacy™ into your school, organisation, or community. We'll guide you through implementation from day one.", cta:"Apply Now" },
              { icon:"🎓", title:"Train Your Team", desc:"Access teacher training, Transformation Weeks, and ongoing support. Over 640 activities to equip every educator.", cta:"Book Training" },
              { icon:"🤖", title:"Integrate Technology", desc:"Leverage our full ecosystem — books, digital tools, AI, and iCHEETAH™ devices for a complete learning experience.", cta:"Explore Tech" },
              { icon:"❤️", title:"Support the Mission", desc:"Donate or sponsor resources to expand literacy access for underserved communities across Jamaica, the US, and Africa.", cta:"Donate" },
            ].map(p=>(
              <div key={p.title} style={{ background:"#FFF9F4", border:"1px solid #EDE0D0", borderRadius:16, padding:28 }}>
                ...
                <button style={{ background:"#F5820A", color:"white", border:"none", borderRadius:50, padding:"10px 20px", fontSize:13, fontWeight:700, cursor:"pointer", fontFamily:"'Nunito',sans-serif" }}>{p.cta} →</button>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section" style={{ background:"linear-gradient(135deg,#0C2340,#1A3A70)" }}>
        <div className="container" style={{ textAlign:"center" }}>
          ...
          <div className="grid-auto">
            {["Proven business acumen since 2014","Aligned with the Science of Reading","Culturally adaptable across countries","Combines education, technology, and training","Designed for measurable outcomes and long-term impact","USA Presidential Lifetime Achievement Award (2024)"].map(r=>(
      ...
      <section className="section" style={{ background:"#FFF0E0" }}>
        <div className="container-xs">
          ...
          <div style={{ background:"white", border:"1px solid #EDE0D0", borderRadius:20, padding:"clamp(20px,4vw,36px)", display:"flex", flexDirection:"column", gap:16 }}>
            ...
            <div><label style={{ display:"block", fontSize:12, fontWeight:700, color:"#0C2340", marginBottom:6 }}>Email Address *</label><input type="email" placeholder="you@example.com" style={{ width:"100%", padding:"11px 14px", border:"1.5px solid #EDE0D0", borderRadius:10, fontSize:14, outline:"none" }} /></div>
            ...
            <div><label style={{ display:"block", fontSize:12, fontWeight:700, color:"#0C2340", marginBottom:6 }}>Country</label><input placeholder="e.g. Jamaica" style={{ width:"100%", padding:"11px 14px", border:"1.5px solid #EDE0D0", borderRadius:10, fontSize:14, outline:"none" }} /></div>
            <button style={{ width:"100%", background:"#F5820A", color:"white", border:"none", borderRadius:50, padding:14, fontSize:15, fontWeight:800, fontFamily:"'Nunito',sans-serif", cursor:"pointer" }}>Join the Literacy Movement →</button>
