...
const resources = [
  ...
  { cat:"Decodable Books", icon:"📖", audience:"parent", title:"CHEETAH® Poster Stories — Level 1", image:"/images/resources/poster-stories.png", desc:"9 Level 1 decodable books for early readers just beginning to decode. Large, poster-format stories ideal for classroom shared reading.", tag:"blue", type:"Physical Book" },
  ...
  { cat:"Charts & Visual Tools", icon:"📊", audience:"teacher", title:"27+ Interactive Charts", image:"/images/resources/interactive-charts.png", desc:"Multisensory reinforcement tools including phonics charts, word family charts, and classroom display resources.", tag:"orange", type:"Physical Resource" },
  { cat:"Flashcards", icon:"🃏", audience:"teacher", title:"Phoneme Flashcard Sets", image:"/images/resources/flashcards-rhymes.png", desc:"Visual flashcard sets for letter-sound practice, sight words, and vocabulary building. Designed for both classroom and home use.", tag:"blue", type:"Physical Resource" },
  ...
  { cat:"Competition", icon:"🏆", audience:"teacher", title:"National Literacy Competition Cards", image:"/images/resources/national-literacy-competition-2.png", desc:"Cards and materials for classroom and national literacy competitions — building motivation, fluency, and confidence.", tag:"green", type:"Competition Resource" },
  ...
  { cat:"Books", icon:"📗", audience:"parent", title:"All JamDER™ & C-DER Books", image:"/images/resources/cder-books.png", desc:"70+ decodable readers — JamDER™ (Jamaica) and C-DER™ (Caribbean) series. Fiction and nonfiction across all levels and cultural contexts.", tag:"green", type:"Book Collection" },
        ...
        <div className="container">
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(clamp(220px,26vw,280px),1fr))", gap:16 }}>
            {[
              ...
              { icon:"🗂️", title:"27+ Interactive Charts", image:"/images/resources/interactive-charts.png", desc:"Multisensory reinforcement tools including phonics charts, word family charts, and classroom display resources." },
